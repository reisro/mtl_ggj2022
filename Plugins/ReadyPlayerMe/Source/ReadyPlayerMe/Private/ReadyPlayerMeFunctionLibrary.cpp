...
USkeletalMeshComponent* UReadyPlayerMeFunctionLibrary::SetupSkeletalMeshComponent(AActor* targetActor, USkeletalMesh* skeletalMesh, const FAvatarMetadata& avatarMetaData, UAnimBlueprint* animBlueprintInstance)
{
	...
	if (avatarMetaData.bodyType == Fullbody && animBlueprintInstance)
	{
...
void UReadyPlayerMeFunctionLibrary::SetAnimationBlueprint(USkeletalMeshComponent* skeletalMeshComponent, UAnimBlueprint* animInstance)
{
	skeletalMeshComponent->SetAnimationMode(EAnimationMode::AnimationBlueprint);
	skeletalMeshComponent->SetAnimInstanceClass(animInstance->GeneratedClass);
}
...
{
	FRegexPattern regexPattern = SHORTCODE_PATTERN;
...
FglTFRuntimeSkeletalMeshConfig UReadyPlayerMeFunctionLibrary::GetglTFRuntimeSkeletalMeshConfig(const FAvatarMetadata & avatarMetaData, USkeleton* skeleton)
{
	...
	if(avatarMetaData.bodyType == Fullbody)
	{
